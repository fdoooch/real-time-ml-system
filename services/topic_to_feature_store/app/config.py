...
class HopsworksSettings(BaseModel):
    ...
    FEATURE_GROUP_PRIMARY_KEYS: list[str] = os.getenv("FEATURE_GROUP_PRIMARY_KEYS", "symbol,timestamp").split(",")
    FEATURE_GROUP_EVENT_TIME: str = os.getenv("FEATURE_GROUP_EVENT_TIME", "timestamp")
